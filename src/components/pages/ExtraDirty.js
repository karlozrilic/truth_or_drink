    ...
    if (state.isLoading) {
        return (
            ...
            <div className="question">
                <ReactLoading type={"spin"} color={"#e32526"} />
            </div>
            </>
        )
    } else {
        return (
            <>
                ...
                {data[current].questions === 1 ?
                    <OneQuestion inp={data[current]} redniBroj={current+1} flare="EXTRA DIRTY" addClass="extraDirty" />
                :
                    <TwoQuestions inp={data[current]} redniBroj={current+1} flare="EXTRA DIRTY" addClass="extraDirty" />
                }
